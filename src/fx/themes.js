...
export const THEMES = {
  NOIR: {
    label: 'NOIR', bg: 'dark', font: 'sans', weight: 800, tracking: 0.01,
  ...
  SWISS: {
    label: 'SWISS', bg: 'light', font: 'sans', weight: 800, tracking: -0.01,
  ...
  POP: {
    label: 'POP', bg: 'accent', font: 'condensed', weight: 900, tracking: 0.02,
  ...
  EDITORIAL: {
    label: 'EDITORIAL', bg: 'light', font: 'serif', weight: 500, tracking: 0.0,
  ...
  GLITCH: {
    label: 'GLITCH', bg: 'dark', font: 'mono', weight: 700, tracking: 0.04,
  ...
  MONO: {
    label: 'MONO', bg: 'mono', font: 'sans', weight: 900, tracking: -0.02,
  ...
  NEON: {
    label: 'NEON', bg: 'neon', font: 'condensed', weight: 900, tracking: 0.04,
  ...
  PASTEL: {
    label: 'PASTEL', bg: 'pastel', font: 'sans', weight: 700, tracking: 0.02,
  ...
  RETRO: {
    label: 'RETRO', bg: 'paper', font: 'serif', weight: 800, tracking: 0.01,
  ...
  RISO: {
    label: 'RISO', bg: 'riso', font: 'condensed', weight: 900, tracking: 0.02,
  ...
  CINEMA: {
    label: 'CINEMA', bg: 'cinema', font: 'sans', weight: 600, tracking: 0.18,
  ...
  ZINE: {
    label: 'ZINE', bg: 'zine', font: 'serif', weight: 900, tracking: 0.0,
